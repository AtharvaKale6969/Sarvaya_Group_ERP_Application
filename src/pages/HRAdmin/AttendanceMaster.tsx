...
export default function AttendanceMaster() {
  ...
  const mockData = [
    { id: '20', name: 'Sahil Pusdekar', org: 'Saravya Group', dept: 'HQ / Operations', designation: 'Intern', date: '01-07-2026', day: 'Wednesday', firstPunch: '10:49 AM', lastPunch: '06:41 PM', workingHours: '7h 52m', breakHours: '-', status: 'HD' },
    { id: '5', name: 'Ekta Satghare', org: 'Saravya Group', dept: 'HQ / Operations', designation: 'Intern - Data Analyst', date: '01-07-2026', day: 'Wednesday', firstPunch: '10:43 AM', lastPunch: '06:59 PM', workingHours: '8h 15m', breakHours: '-', status: 'FD' },
    { id: 'SFS001', name: 'Ankita Kothe', org: 'Shetahit Farm Solutions Private Limited', dept: 'FVF', designation: 'Business Development Associate', date: '01-07-2026', day: 'Wednesday', firstPunch: '10:35 AM', lastPunch: '06:59 PM', workingHours: '8h 24m', breakHours: '-', status: 'FD' },
    { id: 'GC002', name: 'Rakesh Karmakar', org: 'Geoclaim Energy Private Limited', dept: 'Biogas', designation: 'Business Intelligence Analyst', date: '01-07-2026', day: 'Wednesday', firstPunch: '10:21 AM', lastPunch: '06:41 PM', workingHours: '8h 20m', breakHours: '-', status: 'FD' },
    { id: 'EMP031', name: 'Bhushan Chilange', org: 'Saravya Group', dept: 'HQ / Operations', designation: 'Business Development Associate', date: '01-07-2026', day: 'Wednesday', firstPunch: '10:50 AM', lastPunch: '06:57 PM', workingHours: '8h 7m', breakHours: '-', status: 'FD' },
    { id: 'GC001', name: 'Praful Bhalero', org: 'Geoclaim Energy Private Limited', dept: 'Biogas', designation: 'Business Development Associate', date: '01-07-2026', day: 'Wednesday', firstPunch: '10:35 AM', lastPunch: '07:41 PM', workingHours: '9h 5m', breakHours: '-', status: 'FD' },
    { id: 'EMP033', name: 'Faizan Sheikh', org: 'Saravya Group', dept: 'HQ / Operations', designation: 'Business Analyst', date: '01-07-2026', day: 'Wednesday', firstPunch: '10:21 AM', lastPunch: '06:59 PM', workingHours: '8h 37m', breakHours: '-', status: 'FD' },
    { id: 'EMP032', name: 'Atharva Kale', org: 'Saravya Group', dept: 'HQ / Operations', designation: 'Data Analyst', date: '01-07-2026', day: 'Wednesday', firstPunch: '10:38 AM', lastPunch: '06:59 PM', workingHours: '8h 21m', breakHours: '-', status: 'FD' },
    { id: 'PF003', name: 'Himanshu Dhote', org: 'Plastroots Foundation', dept: 'IEC', designation: 'Business Development Associate', date: '01-07-2026', day: 'Wednesday', firstPunch: '09:34 AM', lastPunch: '07:12 PM', workingHours: '9h 37m', breakHours: '-', status: 'FD' },
    { id: 'EMP024', name: 'Aditya Kandekar', org: 'Aayuneer Enterprises', dept: 'Flow Up', designation: 'Business Development Associate', date: '01-07-2026', day: 'Wednesday', firstPunch: '10:40 AM', lastPunch: '09:43 PM', workingHours: '11h 2m', breakHours: '-', status: 'FD' },
  ];
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
          <thead style={{ backgroundColor: '#e0f2fe', borderRadius: '8px' }}>
            <tr>
              ...
              <th style={{ padding: '0.875rem 1rem', fontSize: '0.75rem', fontWeight: '600', color: '#1e3a8a', whiteSpace: 'nowrap' }}>Date</th>
              ...
              <th style={{ padding: '0.875rem 1rem', fontSize: '0.75rem', fontWeight: '600', color: '#1e3a8a', whiteSpace: 'nowrap' }}>Total Break Hours</th>
          ...
          <tbody>
            {filteredData.map((row, index) => (
              <tr key={index} style={{ borderBottom: '1px solid #f3f4f6' }}>
                ...
                <td style={{ padding: '1rem', fontSize: '0.875rem', color: '#4b5563' }}>{row.status}</td>
              </tr>
            ))}
          </tbody>
        </table>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1rem 1.5rem', borderTop: '1px solid #e5e7eb', backgroundColor: '#f9fafb' }}>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
          <div style={{ position: 'relative', marginRight: '1rem' }}>
            <select style={{ appearance: 'none', border: '1px solid #d1d5db', borderRadius: '6px', padding: '0.375rem 2rem 0.375rem 0.75rem', fontSize: '0.875rem', color: '#374151', backgroundColor: 'white', outline: 'none' }}>
