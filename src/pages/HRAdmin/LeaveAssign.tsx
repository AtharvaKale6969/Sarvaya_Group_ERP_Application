...
export default function LeaveAssign() {
  ...
  const [employees, setEmployees] = useState<Employee[]>([
    ...
    { id: 'SFS003', name: 'Vrushabh Raut', org: 'Shetahit Farm Solutions', dept: 'FVF', designation: 'Business Development Associate', leaves: { oh: null, pl: null, sl: null, cl: null, co: null } },
    { id: '23', name: 'Prajwal Wankhede', org: 'Shetahit Farm Solutions', dept: 'MPD', designation: 'Intern', leaves: { oh: null, pl: null, sl: null, cl: null, co: null } },
    ...
    { id: '5', name: 'Ekta Satghare', org: 'Shetahit Farm Solutions', dept: 'FVF', designation: 'Intern - Data Analyst', leaves: { oh: null, pl: null, sl: null, cl: null, co: null } },
    ...
    { id: 'EMP031', name: 'Bhushan Chilange', org: 'Shetahit Farm Solutions', dept: 'FVF', designation: 'Business Development Associate', leaves: { oh: '2', pl: '5', sl: '3', cl: '4', co: null } },
    { id: 'GC001', name: 'Praful Bhalera', org: 'Geoclaim Energy Private Limited.', dept: 'Biomass', designation: 'Business Development Associate', leaves: { oh: '2', pl: '5', sl: '3', cl: '4', co: null } },
  ]);
  ...
  const renderLeaveStatus = (val: string | null) => {
    ...
    return (
      <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center', gap: '2px', color: '#10b981', fontWeight: '500' }}>
