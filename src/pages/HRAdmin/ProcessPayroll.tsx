...
export default function ProcessPayroll() {
  const mockData = [
    ...
    { id: 'EMP024', name: 'Aditya Kandekar', dept: 'AFR', desig: 'Business Development Associate', fd: 17, hd: 0, od: 3, pl: 0, paid: 20, unpaid: 1, dw: 580.65, gw: 18000, ew: 11613, oe: 0, ot: 0, extras: 0, ge: 11613, sc: 0, tds: 0, pen: 0, oded: 0, fa: 11613, la: 0, arr: 0, tp: 11613, ba: 0, pm: '-' },
    ...
    { id: 'GC001', name: 'Praful Bhalero', dept: 'Geoclaim Energy Pvt Ltd.', desig: 'Business Development Associate', fd: 16, hd: 0, od: 3, pl: 0, paid: 19, unpaid: 2, dw: 0, gw: 0, ew: 0, oe: 0, ot: 0, extras: 0, ge: 0, sc: 0, tds: 0, pen: 0, oded: 0, fa: 0, la: 0, arr: 0, tp: 0, ba: 0, pm: '-' }
  ];
